...
function connected(jsn) {
    ...
    $SD.on('com.mijingo.webhooks.action.willAppear', (jsonObj) => action.onWillAppear(jsonObj));
    $SD.on('com.mijingo.webhooks.action.keyUp', (jsonObj) => action.onKeyUp(jsonObj));
    $SD.on('com.mijingo.webhooks.action.sendToPlugin', (jsonObj) => action.onSendToPlugin(jsonObj));
    $SD.on('com.mijingo.webhooks.action.didReceiveSettings', (jsonObj) => action.onDidReceiveSettings(jsonObj));
    $SD.on('com.mijingo.webhooks.action.propertyInspectorDidAppear', (jsonObj) => {
        console.log('%c%s', 'color: white; background: black; font-size: 13px;', '[app.js]propertyInspectorDidAppear:');
    });
    $SD.on('com.mijingo.webhooks.action.propertyInspectorDidDisappear', (jsonObj) => {
